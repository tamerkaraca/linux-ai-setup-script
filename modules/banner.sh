...
print_info_panel() {
    ...
    local version_pad=$((72 - 18 - ${#version_plain}))
    ...
    local developer_pad=$((72 - 18 - ${#developer_plain}))
    ...
    local github_pad=$((72 - 18 - ${#github_plain}))
    ...
    local repo_pad=$((72 - 18 - ${#repo_plain}))
